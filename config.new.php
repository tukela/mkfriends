...
define('UC_DBNAME', '112233'); // UCenter 数据库名称
define('UC_DBCHARSET', 'gbk'); // UCenter 数据库字符集
define('UC_DBTABLEPRE', '`112233`.uc_'); // UCenter 数据库表前缀
define('UC_DBCONNECT', '0'); // UCenter 数据库持久连接 0=关闭, 1=打开
define('UC_KEY', 'e220618eZ0ccd5Cfs1s930z8Ufr2v9X956b8V4U1pes1Lf12S8Gef0YdZdY3hb36'); // 与 UCenter 的通信密钥, 要与 UCenter 保持一致
