...
define('UC_DBPW', 'guja'); // UCenter 数据库密码
define('UC_DBNAME', '778899'); // UCenter 数据库名称
define('UC_DBCHARSET', 'gbk'); // UCenter 数据库字符集
define('UC_DBTABLEPRE', '`778899`.uc_'); // UCenter 数据库表前缀
define('UC_DBCONNECT', '0'); // UCenter 数据库持久连接 0=关闭, 1=打开
define('UC_KEY', 'Q8jeS3L0p5q1k6T6x6ved7j3H8xc66r88bu77fWdyen9Zbh2vbP1hasescGf3957'); // 与 UCenter 的通信密钥, 要与 UCenter 保持一致
