...
已有 <?=$space['viewnum']?> 人次访问, <?=$space['credit']?> 个金豆, <?=$space['experience']?> 个经验
</div>
...
<img id="media_id_<?=$value['feedid']?>" class=movie_pic src="<?php if(!empty($value['image_1'])) { ?><?=$value['image_1']?><?php } else { ?>image/noimg.gif<?php } ?>" alt="点击播放" onclick="javascript:showFlash('<?=$value['body_data']['host']?>', '<?=$value['body_data']['flashvar']?>', this, '<?=$value['feedid']?>');" style="cursor:pointer;" />
  </div>
</div>
...
<ul class="tabs">
         <img src="image/magic/thunder.small.gif">会员动态
</ul>
</div>
...
<p>可获得 <span class="num"><?=$task['credit']?></span> 金豆</p>
</div>
</div>
</div></div></div></div>
<?php } ?>
...
<div class="sidebox">
<h2 class="title">
<p class="r_option"><a href="space.php?do=love">更多</a></p>
<!--<font color='#C10065'>-->推荐情人
</h2>
...
<p>
<a href="cp.php?ac=friend&op=search&all=yes">高级搜索</a><span class="pipe">|</span>
