<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('admin/tpl/event|admin/tpl/header|admin/tpl/side|admin/tpl/footer|template/blue/header|template/blue/footer', '1318238751', 'admin/tpl/event');?><?php $_TPL['menunames'] = array(
		'index' => '管理首页',
		'config' => '站点设置',
		'privacy' => '隐私设置',
		'usergroup' => '用户组',
...
<li<?=$actives['grade0']?>><a href="admincp.php?ac=<?=$ac?>&perpage=20&grade=0&searchsubmit=1"><span>待审核活动</span></a></li>
<li<?=$actives['grade_1']?>><a href="admincp.php?ac=<?=$ac?>&perpage=20&grade=-1&searchsubmit=1"><span>未通过审核活动</span></a></li>
<li<?=$actives['grade1']?>><a href="admincp.php?ac=<?=$ac?>&perpage=20&grade=1&searchsubmit=1"><span>已通过审核活动</span></a></li>
<li<?=$actives['grade_2']?>><a href="admincp.php?ac=<?=$ac?>&perpage=20&grade=-2&searchsubmit=1"><span>已关闭活动</span></a></li>
<li<?=$actives['grade2']?>><a href="admincp.php?ac=<?=$ac?>&perpage=20&grade=2&searchsubmit=1"><span>推荐活动</span></a></li>
</ul>
</div>
...
<tr>
<th>活动ID</th><td><input type="text" name="eventid" value="<?=$_GET['eventid']?>"></td>
...
<option value="<?=$key?>" <?php if($_GET['classid'] == $key) { ?> selected<?php } ?>><?=$value['classname']?></option>
<?php } } ?>
</select>
</td>
</tr>
...
<option value="0"<?php if($_GET['public'] === '0') { ?> selected<?php } ?>>私密</option>
<option value="1"<?php if($_GET['public'] === '1') { ?> selected<?php } ?>>半公开</option>
<option value="2"<?php if($_GET['public'] === '2') { ?> selected<?php } ?>>完全公开</option>
</select>
</td>
</tr>
<tr>
...
<select name="over">
<option value="">不限</option>
<option value="0"<?php if($_GET['over'] === '0') { ?> selected<?php } ?>>未结束</option>
<option value="1"<?php if($_GET['over'] === '1') { ?> selected<?php } ?>>已结束</option>
</select>
</td>
</tr>
<tr>
...
<select name="grade">
<option value="">不限</option>
<option value="-2"<?php if($_GET['grade'] === '-2') { ?> selected<?php } ?>>已关闭</option>
<option value="-1"<?php if($_GET['grade'] === '-1') { ?> selected<?php } ?>>未通过审核</option>
<option value="0"<?php if($_GET['grade'] === '0') { ?> selected<?php } ?>>待审核</option>
<option value="1"<?php if($_GET['grade'] === '1') { ?> selected<?php } ?>>通过审核</option>
<option value="2"<?php if($_GET['grade'] === '2') { ?> selected<?php } ?>>推荐</option>
</select>
</td>
</tr>
...
<tr>
<td>
<input type="<?php if($allowbatch) { ?>checkbox<?php } else { ?>radio<?php } ?>" name="ids[]" value="<?=$value['eventid']?>">
</td>
<td>
...
<?php if($value['grade'] == 0) { ?>待审核
<?php } elseif($value['grade']==-1) { ?>未通过审核
<?php } elseif($value['grade']==2) { ?>推荐
<?php } elseif($value['grade']==-2) { ?>已关闭
<?php } ?>				
</a>
...
<td><?php echo sgmdate('m-d',$value[starttime]) ?> ~ <?php echo sgmdate('m-d',$value[endtime]) ?></td>
