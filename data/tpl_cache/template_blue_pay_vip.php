<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/blue/pay_vip|template/blue/header|template/blue/footer', '1318212828', 'template/blue/pay_vip');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
...
<table border="0" align="right">
  <tr>
    <td width="220" height="48" align="center">	
 <strong> <?php if($vips['ztime'] > 0) { ?>
      <font color="#666666">VIP状态:<?=$vips['day']?> 天</font>		
  <img src="image/pay/vip.gif" alt="VIP会员:<?=$vips['day']?>天" border="0" align="absmiddle" />
<?php } else { ?>
...
<br />
<table width="98%" border="0" align="center" class="formtable">
      <caption>
      <h2>VIP 尊贵特权</h2>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
          <?php if(is_array($arr)) { foreach($arr as $value) { ?>
            <td height="25" align="center" bgcolor="#FFFFFF"><span class="spaf"><?=$value?></span></td>
  <?php } } ?> 
          </tr>
          <?php if(is_array($carr)) { foreach($carr as $value) { ?>
  <tr>
            <td height="25" align="center" bgcolor="#FFFFFF"><span class="spaf"><?=$value['grouptitle']?></span></td>
            <td align="center" bgcolor="#FFFFFF"><?=$value['vip']?></td>
            <td align="center" bgcolor="#FFFFFF"><?=$value['vus']?></td>
            <td align="center" bgcolor="#FFFFFF">
          <?php if($_SCONFIG['viplookinfo'] == 1) { ?>
  <?=$value['vus']?>
          <?php } else { ?>
  <span class="STYLE1">√</span>
          <?php } ?>
</td>
            <td align="center" bgcolor="#FFFFFF"><?=$value['maxattachsize']?></td>
            <td align="center" bgcolor="#FFFFFF"><?=$value['maxfriendnum']?></td>
            <td align="center" bgcolor="#FFFFFF"><?=$value['searchinterval']?></td>
            <td align="center" bgcolor="#FFFFFF"><?=$value['postinterval']?></td>

          <?php if($_SCONFIG['allowdomain'] == 1) { ?>
            <td align="center" bgcolor="#FFFFFF"><?=$value['domainlength']?></td>
  ...
  <tr>
    <td width="135" height="65" align="center" valign="middle"><a href="pay.php?pay=buyvip"></a></td>
    </tr>
  
  <tr>
    <td height="65" align="center" valign="middle"><a href="/pay.php?pay=buyvip"><img src="image/pay/btn.gif" width="137" height="35" border="0" /></a></td>
    </tr>

      <tr>
        <td height="1" colspan="5" bgcolor="#FF9900"></td>
      </tr>
