<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/blue/cp_avatar|template/blue/header|template/blue/cp_header|template/blue/footer', '1318238437', 'template/blue/cp_avatar');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
